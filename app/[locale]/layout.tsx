...
export const metadata: Metadata = {
  ...
  description:
    "Invernaderos, macrotúneles y soluciones tecnológicas para agricultura protegida en México. Especialistas en cultivo de berries, hortalizas y floricultura. Asesoría especializada y tecnología de vanguardia.",
  keywords: [
    "invernaderos",
    "invernaderos México",
    "macrotúneles",
    ...
    "invernaderos para berries",
    "plásticos agrícolas",
    "plásticos agrícolas México",
